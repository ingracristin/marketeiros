...
struct IdeasBottomSheetView<Placeholder: View, Sheet: View>: View {
...
struct IdeasBottomSheetView_Previews: PreviewProvider {
    static var previews: some View {
        IdeasBottomSheetView(offset: .constant(0), isCollpsed: .constant(true), content: {
            VStack {
                Button(action: {
